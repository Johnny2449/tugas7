...
\begin{figure}
\centering
\scalebox{0.65}{\input{Gambar/system_architecture.pdf_tex}}
...
\noindent \begin{minipage}{\linewidth}
    \centering
    \captionof{table}{\footnotesize CONFUSION MATRIX CALCULATION USING SVM FOR CLASSIFICATION}
...
\noindent \begin{minipage}{\linewidth}
    \centering
    \captionof{table}{\footnotesize CONFUSION MATRIX CALCULATION USING NB FOR CLASSIFICATION}
    \begin{tabular}{| p{100px} |l|l|}
    \hline
    \textbf{Class} & \textbf{Normal} & \textbf{Attack}\\
    \hline
...
\noindent \begin{minipage}{\linewidth}
    \captionof{table}{\footnotesize PERFORMANCE EVALUATION WITH NB AND SVM}
    \centering
    \begin{tabular}{| p{100px} |l|l|}
    \hline
     & \textbf{NB} & \textbf{SVM}\\
...
\begin{figure}[h]
\centering
\scalebox{0.35}{\input{Gambar/fig2.pdf_tex}}
...
\begin{figure}[h]
\centering
\scalebox{0.35}{\input{Gambar/fig3.pdf_tex}}
